...
| **🍜 菜品管理** | CRUD + 上下架 + 口味管理 | MinIO/OSS 图片上传，口味关联表 |
...
│       │       ├── controller/           #     控制器层
│       │       │   ├── admin/            #       管理端接口 /admin/**（含 AI 运营诊断）
│       │       │   ├── user/             #       用户端接口 /user/**（含 AI 点餐）
...
│   │       ├── components/               #     全局组件 (Sidebar/Navbar/Breadcrumb/StatCard/...)
